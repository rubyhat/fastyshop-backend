...
> Backup note
>
> Эта ветка и соответствующий тег зафиксированы как резервная точка сохранения перед началом
> крупного рефактора backend-части и полного разворота frontend-архитектуры проекта.
> До релиза эта ветка должна храниться как reference snapshot исходного состояния.
